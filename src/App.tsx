...
const AcademyPage = ({ 
  ...
  const COURSES = [
    { id: 1, videoUrl: "https://www.youtube.com/embed/-hQ9WR81s7c", correctIndices: [0, 1, 3, 1, 0] },
    { id: 2, videoUrl: "https://www.youtube.com/embed/Tr5HT6CE434", correctIndices: [2, 1, 1, 1, 1] },
    { id: 3, videoUrl: "https://www.youtube.com/embed/2nsOyXE1r8w", correctIndices: [1, 2, 1, 2, 0] },
    { id: 4, videoUrl: "https://www.youtube.com/embed/MK-5WmMZ2v0", correctIndices: [1, 3, 1, 1, 1] },
    { id: 5, videoUrl: "https://www.youtube.com/embed/A7FKSs6A-0g", correctIndices: [1, 0, 1, 1, 1] },
    { id: 6, videoUrl: "https://www.youtube.com/embed/_-8WvSPAMdk", correctIndices: [1, 1, 3, 1, 2] },
    { id: 7, videoUrl: "https://www.youtube.com/embed/RUQ2eCqqy9M", correctIndices: [1, 1, 1, 1, 0] },
    { id: 8, videoUrl: "https://www.youtube.com/embed/_naISNlfCTU", correctIndices: [1, 1, 0, 1, 1] },
    { id: 9, videoUrl: "https://www.youtube.com/embed/wPzXiHUOLyU", correctIndices: [1, 1, 1, 1, 0] },
    { id: 10, videoUrl: "https://www.youtube.com/embed/NNd_2ZlJ8EQ", correctIndices: [1, 1, 1, 1, 1] },
    { id: 11, videoUrl: "https://www.youtube.com/embed/aEEPHAexmMo", correctIndices: [0, 1, 1, 1, 1] },
    { id: 12, videoUrl: "https://www.youtube.com/embed/tDthibUPQ8c", correctIndices: [0, 1, 1, 1, 1] },
    { id: 13, videoUrl: "https://www.youtube.com/embed/Rm3HWTNrgp8", correctIndices: [2, 1, 1, 1, 1] },
    { id: 14, videoUrl: "https://www.youtube.com/embed/RM9dbKFGPBQ", correctIndices: [1, 1, 2, 1, 1] },
    { id: 15, videoUrl: "https://www.youtube.com/embed/Fx7nluyaUR0", correctIndices: [0, 1, 1, 1, 1] },
    { id: 16, videoUrl: "https://www.youtube.com/embed/lq4Y0JXtIpY", correctIndices: [0, 1, 1, 1, 0] },
    { id: 17, videoUrl: "https://www.youtube.com/embed/BaeCNJMwBKk", correctIndices: [1, 1, 1, 1, 1] },
    { id: 18, videoUrl: "https://www.youtube.com/embed/DTHy9UW5iZU", correctIndices: [1, 0, 1, 1, 0] },
    { id: 19, videoUrl: "https://www.youtube.com/embed/Fk8p8sj6cHA", correctIndices: [0, 1, 1, 1, 0] },
    { id: 20, videoUrl: "https://www.youtube.com/embed/Z8B6DhNlgKU", correctIndices: [0, 0, 1, 1, 0] }
  ].map(c => ({
    id: c.id,
    title: t(`academy.courses.${c.id}.title`),
    description: t(`academy.courses.${c.id}.description`),
    videoUrl: c.videoUrl,
    questions: [1, 2, 3, 4, 5].map((qIdInCourse, idx) => {
      const globalQuestionId = (c.id - 1) * 5 + qIdInCourse;
      const questionKey = `academy.courses.${c.id}.questions.${globalQuestionId}`;
      return {
        id: globalQuestionId,
        text: t(`${questionKey}.text`),
        options: t(`${questionKey}.options`, { returnObjects: true }) as string[],
        correctIndex: c.correctIndices[idx]
      };
    })
  }));
  ...
  return (
    <div className="flex flex-col gap-6 pb-24">
      <header className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gold-gradient">{t('common.academy') || 'Athena Academy'}</h1>
          <p className="text-gray-400 text-sm">{t('academy.educationalPath')}</p>
        </div>
      </header>
      ...
      <div className="glass rounded-3xl p-6 relative overflow-hidden bg-gradient-to-br from-gold/10 to-transparent">
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">{t('academy.progress')}</span>
          ...
          <div className="p-3 rounded-xl bg-gold/5 border border-gold/10 flex items-start gap-3">
            ...
            <p className="text-[11px] text-gray-400 leading-relaxed">
              <span className="text-gold font-bold">{t('academy.requirement')}:</span> {t('academy.requirementDesc')}
            </p>
          </div>
        </div>
      </div>
      ...
      {!selectedCourse ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-[9px] font-bold text-gray-500">{completedInCourse}/5 {t('academy.steps')}</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            <Icon name="chevron-left" className="w-4 h-4" /> {t('academy.backToModules')}
          </button>
          ...
          <div className="aspect-video bg-black rounded-3xl border border-white/10 flex items-center justify-center overflow-hidden relative">
             {currentCourse?.videoUrl ? (
               ...
               <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-8 text-center bg-black/60 z-10">
                  ...
                  <div>
                     <h4 className="font-bold text-white uppercase tracking-widest text-sm">{t('academy.courseVideo')}</h4>
                     <p className="text-xs text-gray-400 mt-1 italic">{t('academy.videoComingSoon')}</p>
                  </div>
               </div>
             )}
          </div>
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-lg font-bold text-white px-2">{t('academy.knowledgeTest')}</h3>
